...
public class MCSmoothieTest {

	Smoothie s1,s2,s3,s4;
	@Before
	public void setUp() throws Exception {
		s1 = new  Smoothie ("s1", Size.SMALL, 1,false );
		s2 = new  Smoothie ("s2", Size.MEDIUM, 2,true );
		s3 = new  Smoothie ("s3", Size.LARGE, 3, true );
		s4 = new  Smoothie ("s4", Size.SMALL, 4, false );
