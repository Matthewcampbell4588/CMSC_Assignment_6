...
public class MCCoffeeTest {

	Coffee c1,c2,c3,c4;
	@Before
	public void setUp() throws Exception {
		c1 = new  Coffee ("c1", Size.SMALL, false,false );
		c2 = new  Coffee ("c2", Size.MEDIUM, true,true );
		c3 = new  Coffee ("c3", Size.LARGE, false, true );
		c4 = new  Coffee ("c4", Size.SMALL, true, false );
